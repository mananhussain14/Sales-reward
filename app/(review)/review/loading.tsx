 ...
 * swaps.
 *
 * The skeleton mirrors the real page's geometry — header, a four-control filter panel,
 * then a stack of receipt cards — so the swap to real content does not shift the layout.
 *
    ...
    <div className="mx-auto w-full max-w-4xl space-y-6" aria-busy="true">
      ...
      <div aria-hidden="true" className="space-y-6">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-card sm:p-5">
          ...
          {/* Four controls: Retailer, shop, and the two dates. */}
