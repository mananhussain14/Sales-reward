...
-- (20260827090000), 70 (20260828090000), 71 (20260828210000) and 72 (20260829090000)
-- were created by approval and are named exactly. Migration 70 reads rewards and never
-- writes one; Migration 71 adds Azure receipt-extraction readiness; Migration 72
-- corrects retry eligibility in one receipt-extraction read. None changes this
...
select is((select coalesce(string_agg(version, ',' order by version), 'NONE')
  ...
  '20260826090000,20260827090000,20260828090000,20260828210000,20260829090000',
  'A2. the only migrations after 20260825090000 are approved Migrations 68 through 72');
